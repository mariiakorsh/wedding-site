...
export default function WeddingInvitationSite() {
    ...
    },
    {
      ...
      text: "Поможем добраться домой тем, кого уже вымотал этот долгий день, наполненный эмоциями",
      icon: "🚌",
    },
    {
      time: "00:00",
          ...
          <section className="text-center pt-8 pb-12 reveal" data-reveal>
            ...
            <div className="p-5">
              <div className="bg-[#8A9A71]/10 backdrop-blur-sm rounded-[1.4rem] px-4 py-5 shadow-sm border border-white/40">
                <div className="text-[#7A8168] font-medium text-[12px] text-center text-base">
                  СВАДЬБА УЖЕ ЧЕРЕЗ
                </div>
